...
import numpy as np
#loading the dataset
df = pd.read_csv("C:/Users/usach/Desktop/ensemble tech/Diabeted_Ensemble.csv")
...
import numpy as np 
#loading the dataset
df = pd.read_csv("C:/Users/usach/Desktop/ensemble tech/Tumor_Ensemble.csv") 
#2.	Work on each feature of the dataset to create a data dictionary as displayed in the below image
#######feature of the dataset to create a data dictionary
d_types =["count","Binary","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio","ratio"]
...
# Normalized data frame (considering the numerical part of data)
df_norm = norm_func(df.iloc[:,2:31])
df_norm.describe()
...
# Splitting data into training and testing data set
from sklearn.model_selection import train_test_split
x_train, x_test, y_train, y_test = train_test_split(df_norm,target_df, test_size = 0.2,random_state=7)
#for bagging we use label encoded data      
from sklearn import tree 
clftree = tree.DecisionTreeClassifier()
from sklearn.ensemble import BaggingClassifier
...
labelencoder = LabelEncoder()
target_df_array= labelencoder.fit_transform(target_df)
predictors_df_array= df_norm.to_numpy() 
...
import numpy as np 
#loading the dataset
df = pd.read_excel("C:/Users/usach/Desktop/ensemble tech/Coca_Rating_Ensemble.xlsx") 
...
import numpy as np 
#loading the dataset
df = pd.read_excel("C:/Users/usach/Desktop/ensemble tech/Ensemble_Password_Strength.xlsx") 

#2.	Work on each feature of the dataset to create a data dictionary as displayed in the below image
#######feature of the dataset to create a data dictionary

d_types =["nominal","nominal"]
data_details =pd.DataFrame({"column name":df.columns,
                            "data types ":d_types,
                            "data types-p":df.dtypes})
#3.	Data Pre-processing  
...
df["Company"] = labelencoder.fit_transform(df["characters_strength"])
...
# creating instance of labelencoder
labelencoder = LabelEncoder()
target_df_array = labelencoder.fit_transform(df["characters_strength"])
